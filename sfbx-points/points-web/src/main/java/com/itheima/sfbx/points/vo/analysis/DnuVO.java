...
@Data
@NoArgsConstructor
@ApiModel(value = "DnuVO对象", description = "日新增用户数")
public class DnuVO {


    @Builder
    public DnuVO(Long perNums, BigDecimal qoq, BigDecimal qoqLastWeek, Long total, BigDecimal average, LineChartsVO table) {
    ...
    @ApiModelProperty(value = "当日总注册人数")
