...
/**
* @ClassName InsuranceApproveDetailEnum.java
* @Description 保批信息枚举
*/

public enum InsuranceApproveDetailEnum implements IBaseEnum {
    ...
    InsuranceApproveDetailEnum(Integer code, String msg) {
        this.code = code;
        this.msg = msg;
    }
